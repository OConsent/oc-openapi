...
@RestController
public class OcTimestampsApiController implements OcTimestampsApi {

    private static final Logger log = LoggerFactory.getLogger(OcTimestampsApiController.class);
    ...
    public OcTimestampsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<InlineResponse200> ocTimestampsCountGet() {
    ...
    public ResponseEntity<Long> ocTimestampsIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse200> ocTimestampsIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> ocTimestampsIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcTimestamps body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> ocTimestampsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcTimestamps body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
