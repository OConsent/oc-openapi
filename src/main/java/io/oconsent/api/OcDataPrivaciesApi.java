...
public interface OcDataPrivaciesApi {

    @Operation(summary = "", description = "", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-data-privacy" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-data-privacies/count",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocDataPrivaciesCountGet();
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/oc-data-privacies/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Long> ocDataPrivaciesIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);
    ...
    @RequestMapping(value = "/oc-data-privacies/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocDataPrivaciesIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Update a record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-data-privacy" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocDataPrivaciesIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcDataPrivacy body);


    @Operation(summary = "", description = "Create a new record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-data-privacy" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocDataPrivaciesPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcDataPrivacy body);
