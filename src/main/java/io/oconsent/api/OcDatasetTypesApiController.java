...
@RestController
public class OcDatasetTypesApiController implements OcDatasetTypesApi {

    private static final Logger log = LoggerFactory.getLogger(OcDatasetTypesApiController.class);
    ...
    public OcDatasetTypesApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<InlineResponse200> ocDatasetTypesCountGet() {
    ...
    public ResponseEntity<Long> ocDatasetTypesIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse200> ocDatasetTypesIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> ocDatasetTypesIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcDatasetTypes body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> ocDatasetTypesPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcDatasetTypes body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
