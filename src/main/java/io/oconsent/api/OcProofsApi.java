...
public interface OcProofsApi {

    @Operation(summary = "", description = "Retrieve the numver of oc-proofs documents", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-proofs" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-proofs document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-proofs/count",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocProofsCountGet();


    @Operation(summary = "", description = "Find all the oc-proofs's records", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-proofs" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-proofs document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/oc-proofs/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Long> ocProofsIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Find one oc-proofs record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-proofs" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-proofs document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-proofs/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocProofsIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Update a single oc-proofs record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-proofs" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-proofs document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocProofsIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcProofs body);


    @Operation(summary = "", description = "Create a new oc-proofs record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-proofs" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-proofs document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocProofsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcProofs body);
