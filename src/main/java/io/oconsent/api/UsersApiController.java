...
public class UsersApiController implements UsersApi {
    ...
    public ResponseEntity<Body5> usersIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<UsersPermissionsUser> usersIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<UsersPermissionsUser> usersIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewUsersPermissionsUser body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<UsersPermissionsUser>(objectMapper.readValue("{\n  \"role\" : {\n    \"permissions\" : [ \"permissions\", \"permissions\" ],\n    \"name\" : \"name\",\n    \"updated_by\" : \"updated_by\",\n    \"description\" : \"description\",\n    \"id\" : \"id\",\n    \"type\" : \"type\",\n    \"created_by\" : \"created_by\",\n    \"users\" : [ \"users\", \"users\" ]\n  },\n  \"blocked\" : false,\n  \"provider\" : \"provider\",\n  \"id\" : \"id\",\n  \"confirmed\" : false,\n  \"email\" : \"email\",\n  \"username\" : \"username\"\n}", UsersPermissionsUser.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<UsersPermissionsUser> usersMeGet() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<UsersPermissionsUser>(objectMapper.readValue("{\n  \"role\" : {\n    \"permissions\" : [ \"permissions\", \"permissions\" ],\n    \"name\" : \"name\",\n    \"updated_by\" : \"updated_by\",\n    \"description\" : \"description\",\n    \"id\" : \"id\",\n    \"type\" : \"type\",\n    \"created_by\" : \"created_by\",\n    \"users\" : [ \"users\", \"users\" ]\n  },\n  \"blocked\" : false,\n  \"provider\" : \"provider\",\n  \"id\" : \"id\",\n  \"confirmed\" : false,\n  \"email\" : \"email\",\n  \"username\" : \"username\"\n}", UsersPermissionsUser.class), HttpStatus.NOT_IMPLEMENTED);
