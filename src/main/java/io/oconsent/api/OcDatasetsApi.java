...
public interface OcDatasetsApi {

    @Operation(summary = "", description = "Retrieve the numver of oc-datasets documents", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-datasets" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-datasets document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-datasets/count",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocDatasetsCountGet();


    @Operation(summary = "", description = "Find all the oc-datasets's records", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-datasets" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-datasets document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/oc-datasets/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Long> ocDatasetsIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Find one oc-datasets record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-datasets" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-datasets document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-datasets/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocDatasetsIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Update a single oc-datasets record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-datasets" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-datasets document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocDatasetsIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcDatasets body);


    @Operation(summary = "", description = "Create a new oc-datasets record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-datasets" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-datasets document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocDatasetsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcDatasets body);
