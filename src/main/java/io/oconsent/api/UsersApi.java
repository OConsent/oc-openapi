...
public interface UsersApi {
    ...
    @Operation(summary = "", description = "Retrieve all user documents", security = {
    ...
    ResponseEntity<Body5> usersIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Retrieve a single user depending on his id", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - User" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/users/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<UsersPermissionsUser> usersIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Update an existing user", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - User" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = UsersPermissionsUser.class))),
    ...
    ResponseEntity<UsersPermissionsUser> usersIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewUsersPermissionsUser body);


    @Operation(summary = "", description = "Retrieve the logged in user information", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - User" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = UsersPermissionsUser.class))),
    ...
    @RequestMapping(value = "/users/me",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<UsersPermissionsUser> usersMeGet();
