...
public interface UsersPermissionsApi {

    @Operation(summary = "", description = "Retrieve all role documents", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - Role" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(array = @ArraySchema(schema = @Schema(implementation = UsersPermissionsRole.class)))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/users-permissions/roles/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<UsersPermissionsRole> usersPermissionsRolesIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Create a new role", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - Role" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = UsersPermissionsRole.class))),
    ...
    ResponseEntity<UsersPermissionsRole> usersPermissionsRolesPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewUsersPermissionsRole body);


    @Operation(summary = "", description = "Delete a role", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - Role" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/users-permissions/roles/{role}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Body1> usersPermissionsRolesRoleDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("role") String role);


    @Operation(summary = "", description = "Update a role", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - Role" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(schema = @Schema(implementation = UsersPermissionsRole.class))),
    ...
    ResponseEntity<UsersPermissionsRole> usersPermissionsRolesRolePut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("role") String role, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewUsersPermissionsRole body);


    @Operation(summary = "", description = "Search for users", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "UsersPermissions - User" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "response", content = @Content(array = @ArraySchema(schema = @Schema(implementation = UsersPermissionsUser.class)))),
