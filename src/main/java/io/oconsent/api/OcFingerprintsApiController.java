...
import io.oconsent.model.NewOcFingerprints;
...
@RestController
public class OcFingerprintsApiController implements OcFingerprintsApi {

    private static final Logger log = LoggerFactory.getLogger(OcFingerprintsApiController.class);
    ...
    public OcFingerprintsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<InlineResponse200> ocFingerprintsCountGet() {
    ...
    public ResponseEntity<Long> ocFingerprintsIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse200> ocFingerprintsIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> ocFingerprintsIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcFingerprints body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> ocFingerprintsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcFingerprints body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"foo\" : \"foo\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
