...
public interface OcRolesApi {

    @Operation(summary = "", description = "Retrieve the numver of oc-roles documents", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-roles" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-roles document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-roles/count",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocRolesCountGet();


    @Operation(summary = "", description = "Find all the oc-roles's records", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-roles" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-roles document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/oc-roles/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Long> ocRolesIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Find one oc-roles record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-roles" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-roles document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-roles/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocRolesIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Update a single oc-roles record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-roles" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-roles document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocRolesIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcRoles body);


    @Operation(summary = "", description = "Create a new oc-roles record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-roles" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-roles document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocRolesPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcRoles body);
