...
public interface OcEntitiesApi {

    @Operation(summary = "", description = "Retrieve the numver of oc-entities documents", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-entities" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-entities document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-entities/count",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocEntitiesCountGet();


    @Operation(summary = "", description = "Find all the oc-entities's records", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-entities" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-entities document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "unexpected error", content = @Content(schema = @Schema(implementation = Error.class))) })
    @RequestMapping(value = "/oc-entities/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Long> ocEntitiesIdDelete(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Find one oc-entities record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-entities" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-entities document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    @RequestMapping(value = "/oc-entities/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse200> ocEntitiesIdGet(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id);


    @Operation(summary = "", description = "Update a single oc-entities record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-entities" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-entities document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocEntitiesIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcEntities body);


    @Operation(summary = "", description = "Create a new oc-entities record", security = {
        @SecurityRequirement(name = "bearerAuth")    }, tags={ "Oc-entities" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Retrieve oc-entities document(s)", content = @Content(schema = @Schema(implementation = InlineResponse200.class))),
    ...
    ResponseEntity<InlineResponse200> ocEntitiesPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody NewOcEntities body);
